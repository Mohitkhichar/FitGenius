...
class diet
{
    public:
        ...
        {  // virtual funtion used.
            ...
            { // if the person is non vegetarian
...
class dat: public diet{  // inheriting diet class just for the sake of oops concept
    ...
    dat(int a, int b, int c){  // constructor overloading
        day=a;
        month=b;
        yr=c;
        m[1]=m[3]=m[5]=m[7]=m[8]=m[10]=m[12]=31;
...
void registerpassword(){  // for sign up 
    ...
    if(password == password2){
        ...
        switch(choice){
            case 1:{
                W.fat_loss();    // for lossing the weight
                W.subscription();
                mov="1";
                break;
            }
            case 2:{
                W.ab_workouts();     // abs workout
                W.subscription();
                mov="2";
                break;
            }
            ...
            case 5:{
                W.Cardio();       // cardio exercise
                W.subscription();
                mov="";
                break;
            }
            case 6:{            // full body tonning
                W.Fullbodytonning();
                W.subscription();
                mov="6";
                break;  
            ...
            case 7:{
                W.Break_up();    // joining to forget things about your ex
                mov="7";
                break;
            }
        }
